...
<table id="recipes">
    ...
    <tbody>
        <tr>
            ...
            <td><img src="images/twotimes_tnt.png" alt="2 normal TNT side by side"></td>
            <td><img src="images/twotimes_tnt_texture.png" alt="Purple TNT"></td>
        </tr>
        <tr>
            <td>5x TNT</td>
            <td>Makes an explosion with the power of 5</td>
            <td><img src="images/fivetimes_tnt_recipe.png" alt="4 normal TNT in all four corners of the crafting table with one in the middle"></td>
            <td><img src="images/fivetimes_tnt_texture.png" alt="Yellow TNT"></td>
        </tr>
        <tr>
            <td>10x TNT</td>
            <td>Makes an explosion with the power of 10</td>
            <td><img src="images/tentimes_tnt_recipe.png" alt="Two 5x TNTs side by side"></td>
            <td><img src="images/tentimes_tnt_texture.png" alt="Blue TNT"></td>
        </tr>
        <tr>
            <td>Immediate TNT</td>
            <td>Makes a normal explosion but explodes instantly</td>
            <td><img src="images/immediate_tnt_recipe.png" alt="One normal TNT in the middle of the crafting table with redstone dust surrounding on all sides"></td>
            <td><img src="images/immediate_tnt_texture.png" alt="Dark gray TNT"></td>
        </tr>
        <tr>
            <td>Nuclear TNT</td>
            <td>Makes an huge, fiery explosion</td>
            <td><img src="images/nuclear_tnt_recipe.png" alt="4 fire charges in the corners of the crafting table with two 10x TNTs on each side (horizontally), two blaze powder on each side (vertically), and a nether star in the middle"></td>
            <td><img src="images/nuclear_tnt_texture.png" alt="Yellowish-orange TNT"></td>
        </tr>
        <tr>
            <td>Hole TNT</td>
            <td>Makes a big hole in the ground</td>
            <td><img src="images/hole_tnt_recipe.png" alt="Six TNT all side by side on the bottom of the crafting table with a piston in the top middle and redstone dust on each side (horizontally) of the piston"></td>
            <td><img src="images/hole_tnt_texture.png" alt="Orange TNT"></td>
        </tr>
        <tr>
            <td>Diamond Ore TNT</td>
            <td>Makes a 3 by 3 by 3 cube of diamond ore</td>
            <td><img src="images/diamondore_tnt_recipe.png" alt="One piece of normal TNT in the middle of the crafting table with diamond ore surrounding on all sides"></td>
            <td><img src="images/diamondore_tnt_texture.png" alt="Diamond ore but with the TNT label on it"></td>
        </tr>
        <tr>
            <td>Deepslate Diamond Ore TNT</td>
            <td>Makes a 3 by 3 by 3 cube of deepslate diamond ore</td>
            <td><img src="images/deepslatediamondore_tnt_recipe.png" alt="One piece of normal TNT in the middle of the crafting table with deepslate diamond ore surrounding on all sides"></td>
            <td><img src="images/deepslatediamondore_tnt_texture.png" alt="Deepslate diamond ore but with the TNT label on it"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><img src="images/worldeater_tnt_recipe.png" alt="First slot contains a Nether star, second slot contains an enchanted golden apple, third slot contains a dragon head, fourth slot contains a dragon egg, fifth slot contains a piece normal tnt, sixth slot contains a heart of the sea, seventh slot contains a heavy core, eighth slot contains a totem of undying, ninth slot contains an elytra"></td>
            <td><img src="images/worldeater_tnt_texture.png" alt="Solid black TNT"></td>
        </tr>
        <tr>
            <td>Ice TNT</td>
            <td>Turns all blocks in a nearby radius into ice</td>
            <td><img src="images/ice_tnt_recipe.png" alt="One piece of TNT in the middle of the crafting table with ice surrounding on all sides"></td>
            <td><img src="images/ice_tnt_texture.png" alt="A block of ice with the TNT label on it"></td>
        </tr>
        <tr>
            <td>Nether TNT</td>
            <td>Turns all blocks in a nearby radius into Nether blocks</td>
            <td><img src="images/nether_tnt_recipe.png" alt="One piece of TNT in the middle of the crafting table with Netherrack surrounding on all sides"></td>
            <td><img src="images/nether_tnt_texture.png" alt="TNT but the background color is the average color of Netherrack"></td>
        </tr>
    </tbody>
</table>
